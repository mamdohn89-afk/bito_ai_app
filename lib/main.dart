...
Future<void> initNotifications() async {
  ...
  await notificationsPlugin.periodicallyShow(
    0,
    'وقت المذاكرة 🎯',
    'لا تنسى مذاكرة اليوم مع BitoAI',
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                _controller.loadUrl(urlRequest: URLRequest(url: WebUri('https://studybito.com')));
...
} // ✅ هذا يغلق الكلاس _BitoAIAppState
